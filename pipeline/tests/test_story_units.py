...
def test_dedupe_preserves_earlier_opening_when_only_payoff_identity_matches():
    def candidate(
        candidate_id: str,
        anchor: str,
        start: float,
    ...
    result = cheap_filter_and_dedupe([
        candidate("later-opening", "S0", 85.0, 140.0, 1.0),
        candidate("earlier-opening", "S1", 60.0, 120.0, 0.8),
    ], limit=10)
