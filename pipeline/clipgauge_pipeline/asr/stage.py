...
def _asr_details(
    ...
    *,
    ...
    return {
        ...
        "available_ram_source": capabilities.get("available_ram_source"),
        ...
        "cgroup_memory_limit_bytes": capabilities.get("cgroup_memory_limit_bytes"),
        "cgroup_memory_current_bytes": capabilities.get("cgroup_memory_current_bytes"),
