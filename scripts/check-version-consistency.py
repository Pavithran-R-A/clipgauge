...
if not re.search(r"^## \[0\.1\.1\](?:\s|$)", changelog, re.MULTILINE):
    errors.append("CHANGELOG.md: missing current v0.1.1 section")

readme = (ROOT / "README.md").read_text()
if "ClipGauge v0.1.1" not in readme:
    errors.append("README.md: missing current ClipGauge v0.1.1 marker")
...
if "ClipGauge v0.1.1" not in about:
    errors.append("About.tsx: missing current ClipGauge v0.1.1 marker")
