...
if not re.search(r"^## \[0\.5\.7\](?:\s|$)", changelog, re.MULTILINE):
    errors.append("CHANGELOG.md: missing current v0.5.7 section")

readme = (ROOT / "README.md").read_text()
if "ClipGauge v0.5.7" not in readme:
    errors.append("README.md: missing current ClipGauge v0.5.7 marker")
...
if "ClipGauge v0.5.7" not in about:
    errors.append("About.tsx: missing current ClipGauge v0.5.7 marker")
