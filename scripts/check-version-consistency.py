...
if not re.search(r"^## \[0\.5\.22\](?:\s|$)", changelog, re.MULTILINE):
    errors.append("CHANGELOG.md: missing current v0.5.22 section")
...
if "ClipGauge v0.5.22" not in about:
    errors.append("About.tsx: missing current ClipGauge v0.5.22 marker")
