...
describe('v0.5 information architecture', () => {
  ...
  it('uses fresh cached GPU diagnostics until explicitly refreshed', () => {
    ...
    window.localStorage.setItem('clipgauge.setup.gpu.v1', JSON.stringify({ schema_version: 1, app_version: '0.6.0', identity: { gpu_identity: ['Cached GPU'], driver_version: ['1.0'], cuda_runtime_fingerprint: '{}', cudnn_runtime_fingerprint: '{}', pipeline_environment_fingerprint: null }, value: cachedGpu, verifiedAt: new Date().toISOString() }))
  ...
  it('persists GPU identity and runtime fingerprints with fresh diagnostics', async () => {
    ...
    expect(cached.app_version).toBe('0.6.0')
